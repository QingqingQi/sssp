package com.software.sssp.handler;
...
import com.software.sssp.service.DepartmentService;
import com.software.sssp.service.EmployeeService;
...
public class EmployeeHandler {
	...
	public void getEmployee(@RequestParam(value="id", required=false) Integer id,
		...
		if(id != null) {
			...
			employee.setDepartment(null);//解决不能修改员工的 Department 问题
